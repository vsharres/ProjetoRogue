...
class VICTORYBPLIBRARY_API UVictoryBPFunctionLibrary : public UBlueprintFunctionLibrary
{
	...
	*/ 
	...
	UFUNCTION(BlueprintCallable, Category = "VictoryBPLibrary|Screenshoots", meta=(Keywords="High resolution"))
	static bool ScreenShoots_Rename_Move_Most_Recent(FString& OriginalFileName, FString NewName, FString NewAbsoluteFolderPath, bool HighResolution=true);
	...
	*/
	...
	/*** InstallDir/GameName/Saved/Screenshoots/Windows */
	UFUNCTION(BlueprintPure, Category = "VictoryBPLibrary|Paths")
